...
<template>
  <section class="data-view page-width">
    ...
    <div class="data-summary-grid">
      ...
      <article><span>游戏头像</span><strong>{{ data.summary.portraitCount }}</strong><small>DDS 已还原为透明 PNG</small></article>
      ...
      <div class="data-main-column">
        ...
        <section class="data-card source-tree-card">
          ...
          <div class="source-tree">
            ...
            <div><span>头像图集</span><code>gui_portraits.lua + gui_portraits-1.dds</code></div>
          </div>
        </section>
      </div>

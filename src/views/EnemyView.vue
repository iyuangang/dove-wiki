...
function onKeydown(event: KeyboardEvent) {
  if (event.key === 'Escape') selectedEnemy.value = null
}

watch(selectedEnemy, (enemy) => {
  document.body.classList.toggle('modal-open', Boolean(enemy))
  if (enemy) window.addEventListener('keydown', onKeydown)
  ...
  <section class="enemy-view page-width">
    ...
    <Teleport to="body">
      <Transition name="panel">
        <div v-if="selectedEnemy" class="enemy-detail-overlay" role="presentation" @mousedown.self="selectedEnemy = null">
          <aside class="enemy-detail-panel" role="dialog" aria-modal="true" :aria-label="`${selectedEnemy.name}详情`">
